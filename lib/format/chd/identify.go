...
// NewISO9660Reader returns an io.ReaderAt suitable for ISO9660 identification
// from a CHD file. It handles sector translation for CD-ROM CHD files where
// sectors contain raw 2352-byte data plus subchannel data.
func NewISO9660Reader(r io.ReaderAt, size int64) (io.ReaderAt, int64, error) {
	// Create CHD reader
