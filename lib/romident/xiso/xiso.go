...
// Identify verifies the format and extracts game identification from an XISO.
func Identify(r io.ReaderAt, size int64) (*core.GameIdent, error) {
	...
	return xbe.XboxInfoToGameIdent(info), nil
}

// parseXISO extracts game information from an Xbox XISO image.
func parseXISO(r io.ReaderAt, size int64) (*xbe.XboxInfo, error) {
	...
	return xbe.ParseXBEAt(r, xbeOffset)
}
